...
# Ideal input columns: date,rank,song,artist,last-week,peak-rank,weeks-on-board,genre
...
# Save correlation dataframe to file
correlation.to_csv('correlation_fake.csv')

# 6. TODO Next Step: Visualize correlation data
# TODO Replace all fake data with real data
